...
subtest 'exact = match' => sub {
    ...
    is_deeply \@r,
              [ 'alice', '1001', '1001',
                't/fixtures/domains/realhome', '', '', '' ],
              'exact =alice returns full 7-field tuple';

    @r = qmail_user('bare');
    is_deeply \@r,
              [ 'bare', '1010', '1010',
                't/fixtures/domains/bare-vpop', '', '', '' ],
